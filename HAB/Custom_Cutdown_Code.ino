...
void loop() {
  ...
  if (millis() - timer > 30000) { 
   ...
   //Uncomment to print out GPS data
    ...
    //5 cutdown attempts
      if((alt > 20000) && (cutdown_trys < 5)){   //Max Altitude in meters
      ...
      if((lat > 46.214839) && (cutdown_trys < 5)){   //Max Lattitude (Assumed North)
        digitalWrite(trigger_out, HIGH);
        delay(15000);
        Serial.println("Cutdown");
        Serial.println("Attempt");
      ...
      if((lat < 40.0) && (cutdown_trys < 5)){ //Min Lattidude (Assumed North)
        digitalWrite(trigger_out, HIGH);
        delay(15000);
        Serial.println("Cutdown");
        Serial.println("Attempt");
      ...
      if((longi > 119.240942) && (cutdown_trys < 5)){  //Max Longitude (Assumed West)
        digitalWrite(trigger_out, HIGH);
        delay(15000);
        Serial.println("Cutdown");
        Serial.println("Attempt");
    ...
    if((longi < 100.0) && (cutdown_trys < 5)){  //Max Longitude (Assumed West)
        digitalWrite(trigger_out, HIGH);
        delay(15000);
        Serial.println("Cutdown");
        Serial.println("Attempt");
